...
public class HoaDonChiTiet extends javax.swing.JDialog {
    ...
    private HoaDonChiTietRepository re = new HoaDonChiTietRepository();
    private int index;
    /**
    ...
    private void load(){
        int idHdct = ToanCuc.getIdHoaDonChiTiet();
        ArrayList<main.entity.HoaDonChiTiet> list = new ArrayList<>();
        list = re.getHdct(idHdct);
        for(main.entity.HoaDonChiTiet hdct: list){
            model.addRow(hdct.toTable1());
        }
    ...
    private void initComponents() {
        ...
        tblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Hoá Đơn", "Tên Sản Phẩm", "Imei", "Giá Tiền"
            }
        ) {
